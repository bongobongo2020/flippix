...
namespace FlipPix.UI.Linux.ViewModels
{
    public partial class FlipPixViewModel : BasePromptViewModel, IDisposable
    {
        ...
        private void OpenResultFolder()
        {
            ...
            {
                Process.Start(new System.Diagnostics.ProcessStartInfo { FileName = "xdg-open", Arguments = System.IO.Path.GetDirectoryName(ResultImagePath) ?? string.Empty, UseShellExecute = false });
            }
        }
        ...
        private void NavigateToImageGenerator()
        {
            ...
            try
            {
                ...
                {
                    imageGeneratorWindow.WindowState = Avalonia.Controls.WindowState.Normal;
        ...
        private void NavigateToImageAnalyzer()
        {
            ...
            try
            {
                ...
                {
                    imageAnalyzerWindow.WindowState = Avalonia.Controls.WindowState.Normal;
        ...
        private void NavigateToVideoGenerator()
        {
            ...
            try
            {
                ...
                if (videoWindow != null)
                {
                    ...
                    {
                        videoWindow.WindowState = Avalonia.Controls.WindowState.Normal;
        ...
        private void NavigateToStoryVideo()
        {
            ...
            try
            {
                ...
                {
                    storyVideoWindow.WindowState = Avalonia.Controls.WindowState.Normal;
