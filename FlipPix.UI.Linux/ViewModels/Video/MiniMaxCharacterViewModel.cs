...
namespace FlipPix.UI.Linux.ViewModels.Video
{
    ...
    public partial class MiniMaxCharacterViewModel : VideoProcessingBaseViewModel
    {
        ...
        /// </summary>
        /// <summary>
        /// Avalonia's ShowDialog always needs an owner. With no active window (only possible
        /// during teardown) fall back to showing the picker as a top-level window and awaiting
        /// its close.
        /// </summary>
        ...
        private async Task OpenSceneLibraryAsync()
        {
            try
            {
                ...
                var window = new FlipPix.UI.Linux.Windows.ScenePromptLibraryWindow(_sceneLibrary, _scenes!);

                // Avalonia's ShowDialog returns the value the window closed with, so the picked
                // scene comes back directly instead of through WPF's DialogResult/SelectedScene pair.
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.MessageBox.Show($"Could not open the scene library:\n{ex.Message}",
        ...
        private async Task JoinClipsManuallyAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.MessageBox.Show($"Could not join the clips:\n{ex.Message}",
