    ...
    public partial class H3CastViewModel : VideoProcessingBaseViewModel
    {
        ...
        private async Task BuildSheetsAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.MessageBox.Show($"Building the character sheets failed:\n{ex.Message}",
        ...
        private async Task LoadStoryFileAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.MessageBox.Show($"Could not read that file:\n{ex.Message}",
                    "H3 Cast", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private async Task RederiveWardrobeAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.MessageBox.Show($"Writing the wardrobe failed:\n{ex.Message}",
                    "H3 Cast", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            finally
            {
