<!-- The official MiniMax H3 "Video Prompt Writing Guide (T2VA / I2VA / FL2VA / L2VA)", bundled
     verbatim with duckyshell/ComfyUI-MiniMaxH3-Prompt-Writer (guides/VIDEO_PROMPT_WRITING_GUIDE_base_en.md,
     upstream MiniMax terms, MIT-licensed package). This is the guide the H3 Prompt Writer sends with
     every generation; the H3 Experimental tab's prompt-writer tool call is built on it. -->
