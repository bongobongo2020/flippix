...
- `[Shot 1]` carries **no timestamp**. Open it with the visual style (`Anime cinematic in a high-production gacha style`, `Live-action, cinematic`, `3D CG`, `stop-motion`, …), then the shot size and camera angle, then the subject in full detail.
